...
Quality bar for everything an agent writes into Vivia: titles, descriptions, acceptance criteria, executionRecords, decisions, files, tags, edges, categories, and the markdown tone of all of it.
